...
import {editFood, getFood} from '../actions/foodActions';
...
class EditFood extends React.Component {
  ...
  componentDidMount() {
    this.props.dispatch(getFood(this.props.token, this.props.match.params.foodId));
    console.log(this.props.food);
    this.setState({
      manufacturer: this.props.food.manufacturer,
      description:this.props.food.description,
      energy: this.props.food.energy,
      carbs: this.props.food.carbs,
      sugar: this.props.food.sugar,
      fiber: this.props.food.fiber,
      fat: this.props.food.fat,
      saturated: this.props.food.saturated,
      unsaturated: this.props.food.unsaturated,
      protein: this.props.food.protein,
      salt: this.props.food.salt
    });
  }
  ...
  onSubmit = (event) => {
    event.preventDefault();
      ...
      salt:this.state.salt
		...
		this.props.dispatch(editFood(this.props.token, this.props.match.params.foodId, food));
    ...
    return (
      <Container>
        ...
        <Form.Group as={Row} className="pt-3">
          <Col md={10}>
            <Button className="mr-1" variant="success" onClick={this.onSubmit} >Save Changes</Button>
...
export default withRouter(connect(mapStateToProps)(EditFood));